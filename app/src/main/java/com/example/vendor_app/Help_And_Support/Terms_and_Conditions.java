...
public class Terms_and_Conditions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        termsAndCondition = findViewById(R.id.txtTermsAnsCondition);

        String Terms = "Terms & Conditions\n" +
                "\n" +
                "\n" +
                "This document describes policy of Mekvahan.com (hereafter referred to as \" Mekvahan \") regarding information received by Mekvahan during your visits to our website or App. The amount and type of information received depends on how one uses the site or app. Mekvahan is a website/app which is the property of Udyamat Ma Viramsava Pvt. Ltd. a company registered under the Companies Act, 2013, having its registered office at Aya Nagar Extn., Delhi - 110047.\n" +
                "\n" +
                "What is Mekvahan.com?\n" +
                "\n" +
                "Mekvahan.com is a Online Platform / Public forum which is completely into an automotive sector that provides different types of regular services as well as SOS services (On road and roadside assistance), also known as emergency services .\n" +
                "\n" +
                "'Customer'\n" +
                "\n" +
                "Customer is a visitor on Mekvahan.com website or Mekvahan app who is a registered member and has filled up the form on the website, is not a dealer or not a partner of dealer or not an associate of dealer or who has no objection contacting any car/bike dealer for his car/bike servicing.\n" +
                "\n" +
                "'Service Vendor' / 'Car/bike Vendor' / 'Car/bike Service Vendor'\n" +
                "\n" +
                "A workshop, motor vehicle service workshop which deals with motor vehicle servicing, repairing and/or provides motor vehicle servicing related facility.\n" +
                "\n" +
                "'Franchisee', 'Distributor'\n" +
                "\n" +
                "A representative who represents Mekvahan cities all across India. A representative has Distributor agreement with Mekvahan to operate his office using brand and help Mekvahan customers all across India\n" +
                "\n" +
                "Mekvahan.com Objective - Comfort and Choice\n" +
                "\n" +
                "Providing Customers with a platform to help customer members to book services online  and then the service is done by registered motor vehicle service vendors authorised/certified by Mekvahan. Mekvahan.com is using technology available for WEB and Mobile to allow them to send enquiries and get response from motor vehicle service vendors. Mekvahan is working on \"CUSTOMER CHOICE\" to allow customers to choose the best service for their motor vehicle.\n" +
                "\n" +
                "Value Added Products and Services (VAPS) are provided by Mekvahan for the benefit of customers by associating with other companies. These are products supplied by Mekvahan \"as it is\" as per suppliers/manufacturer's terms and conditions, and Mekvahan acts as a \"reseller\" \"dealer\" of that products or services.\n" +
                "\n" +
                "'Leads'\n" +
                "\n" +
                "Lead means \"enquiry\" generated through online/ offline promotion. It is categorised as a \"QualifiedLead”if the name of the customer and its contact information is correct. “Lead\"and \"lead generation\" does not mean customers will use your services, in other words, a \"lead\" can be considered as \"conversion\", but it may not necessarily result in a Customer actually visiting a dealer. \"Leads\" in all agreements with Service vendors/associates/partners under \"lead generation program\" or \"revenue share program\" are \"qualified\" leads.\n" +
                "\n" +
                "NOTE: All terms and conditions are applicable to \"Every page\" on this domain http://www.mekvahan.com even if it is not mentioned on the page, all visitors must consider this as assumption.\n" +
                "\n" +
                "How It Works\n" +
                "\n" +
                ...
                "6.1 Google Advertising Cookie and Privacy Policies\n" +
                "We use third-party advertising companies to serve ads when you visit our website. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you. If you would like more information about this practice and to know your choices about not having this information used by these companies, click here\n" +
                "6.2 Communication Mediums\n" +
                "You agree to receive promotional, transactional and commercial communications from Mekvahan through email,SMS and voice.\n" +
                "7. CONDUCT\n" +
                ...
                "That impersonates any person or entity, including, but not limited to, a Mekvahan employee, or falsely state or otherwise misrepresent your affiliation with a person or entity (this provision does not apply to messages that are lawful non-deceptive parodies of public figures.).\n" +
                "That includes personal or identifying information about another person without that person's explicit consent.\n" +
                "That is false, deceptive, misleading, deceitful, misinformative, or constitutes \"bait and switch\".\n" +
                "That infringes on any patent, trademark, trade secret, copyright or other proprietary rights of any party, or Content that you do not have a right to make available under any law or under contractual or fiduciary relationships.\n" +
                ...
                "That constitutes or contains any form of advertising or solicitation if: posted in areas of the Mekvahan sites which are not designated for such purposes; or emailed to Mekvahan users who have not indicated in writing that it is ok to contact them about other services, products or commercial interests.\n" +
                "That includes links to commercial services or web sites, except as allowed in \"services\".\n" +
                "That advertises any illegal service or the sale of any items the sale of which is prohibited or restricted by any applicable law, including without limitation items the sale of which is prohibited or regulated by Indian law.\n" +
                ...
                "Use automated means, including spiders, robots, crawlers, data mining tools, or the like to download data from the Service - unless expressly permitted by Mekvahan.\n" +
                ...
                "Attempt to gain unauthorized access to Mekvahan's computer systems or engage in any activity that disrupts, diminishes the quality of, interferes with the performance of, or impairs the functionality of, the Service or the Mekvahan website. \n" +
                "Use any form of automated device or computer program that enables the submission of postings on Mekvahan without each posting being manually entered by the author thereof (an \"automated posting device\"), including without limitation, the use of any such automated posting device to submit postings in bulk, or for automatic submission of postings at regular intervals.\n" +
                "8. NO SPAM POLICY\n" +
                ...
                "19. Terms and conditions for Motor Vehicle Helpline- On-Road Assistance\n" +
                "Mekvahan associated with Car/bike On-Road Emergency Service Companies and do not provide this service itself.\n" +
                "This service is provided as per terms and conditions stated by Car/bike Emergency Breakdown Company.\n" +
                "All disputes arising from this \"value added services\" should be dealt directly with associated companies.\n" +
                "Services are available within border areas of Delhi & NCR.\n" +
                "Services will be provided only when the vehicle develops fault while on the road. Mekvahan does not guarantee any reach time for service provided.\n" +
                "It’s mandatory for the customer making helpline call to produce either the card or the sticker to avail the required services.\n" +
                "If the vehicle is repairable on road, free towing/dropping service will not be provided.\n" +
                "Wheel tube repair services will be provided for a flat tyre at actual cost.\n" +
                "Claims/Refunds if any will not be exceed the residual value (on per day prorated basis of Card validity period) of the card fees paid by the Cardholder as on the date of the claim.\n" +
                "It will be considered that all the terms & conditions are accepted by the cardholder once the services are utilized by him even if the card subscription form does not reach this office duly filled in and signed by the Cardholder concerned.\n" +
                "Service of opening of cars with keys locked inside or bike key lost will be given if possible with standard tools available.\n" +
                "Towing of vehicle may not be provided between 8 am to 11 am and 5 pm to 8 pm or any other restriction imposed by the traffic police, and towing shall at no point of time be free. The Customer will have to pay the rate stipulated.\n" +
                "Vehicles older than 15 years at the time of enrolling shall not be accepted for service.\n" +
                "The company will try and ensure to provide service within the stipulated time of 30 minutes but it cannot be held responsible for any delay arising due to conditions not within its control.\n" +
                "The customer or its representative will have no claim against the company or its representative either civil or criminal nature or pursuant to this card in respect of death or injury of the customer or any other person or loss or damage to any other property caused by or due to equipment failure, breakdown or accident or fire on utilization of services during the validity of the card.\n" +
                "Receipts for cost of Petrol/Diesel will not be provided.\n" +
                "\n" +
                ...
                "20. Special Offers Campaign / Hot Deals\n" +
                "20.1.Mekvahan runs campaigns from time to time at all occasions for awareness and promotional purposes.\n" +
                ...
                "\n" +
                "23. REFUND POLICY\n" +
                "Cancellation/Refund policy :- Mekvahan believes in helping its customers as far as possible, and has therefore a liberal cancellation/refund policy.\n" +
                "\n" +
                "Cancellation Policy:-\n" +
                "\n" +
                "Under this policy:\n" +
                "\n" +
                "Cancellation request can be made via the Mekvahan Mobile Application to make a booking or via call or e-mail to care@mekvahan.com.\n" +
                ...
                "Under this policy:\n" +
                "\n" +
                "Refund can be claimed only after service order cancellation.\n" +
                ...
                "\n" +
                "Prepaid Service Cancellation Refund (if applicable)\n" +
                "\n" +
                "In case of the cancellation of the service if the payment was prepaid and the pickup was not done, we will not charge any cancellation charges and we will refund your money.\n" +
                ...
                "\n" +
                "No Refund Policy Cases (Applicable to all services contracts)\n" +
                "EXPIRY Contract.\n" +
                "Non Receive of Application through proper channel (email/post)\n" +
                "Receive of Some Services or Deliverables.\n" +
                "Pressurising staff/employee in a wrong way.\n" +
                "Defame company without prior request to company.\n" +
                "\n" +
                "FOR DEALER/WORKSHOP/OUTLET\n" +
                "No refund for EXPIRY contract.\n" +
                "Forcing/pushing company or individual (by wrong way of pressure/force) for refund is considered to be illegal and No refund will be claimed if proven wrong way of pressure on any associate / employee/staff.\n" +
                "Mekvahan.com is promotion/marketing company and do not guarantee for any amount of business until specified in the contract.\n" +
                "Dealer/Workshop/merchant/outlets can request for refund using proper channel of the company/process and cannot force/push/pressure/coerce anybody for refund.\n" +
                "However, Mekvahan does not guarantee any refund, and it merely facilitates.\n" +
                "\n" +
                "FOR CUSTOMER MEMBERSHIPS\n" +
                "Customer memberships includes services provided by Merchant/Workshop/Dealer/Outlet so Mekvahan can help customers servicing them, but cannot take guarantee for their quality of services.\n" +
                "Customer can ask for refund in case of SERVICES not been offered.\n" +
                "Once all memberships coupons/cards/material sent to customer or delivered, customer cannot ask for refund until they have not been serviced by merchant/members/workshop/outlet.\n" +
                "In case of problems with quality of workshop service, Mekvahan.com can mediate dispute but the customer cannot claim for any refund or settlement from Mekvahan.com. \n" +
                "Mekvahan.com is doing regular effort to bring BEST merchant/workshops/outlet on one platform as a concept, but customer members need to check themselves if merchant/workshop/outlet is serving as per commitment. Mekvahan.com ask for feedback and try to resolve dispute (with mutual consent from both parties-customer and workshop), but cannot take guarantee for every service.\n" +
                "FOR EXCLUSIVE PARTNERSHIP / LONG TERM CONTRACT TERMINATION\n" +
                "Exclusive Contract / Corporate company can request for refund using proper channel of the company/process.\n" +
                "Refund will be paid after adjustment of work done by Mekvahan.com team.\n" +
                "Refund shall be requested within 3 months’ notice period of Termination of the contract, as stated in the contract.\n" +
                "Minimum 3 months shall be considered for refund.\n" +
                "Termination letter shall be written officially and duly signed by the authority of the company.\n" +
                "Forcing/pushing company or individual (by wrong way of pressure/force) for refund is considered to be illegal.\n" +
        ...
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),0,18,0);
        spannableString.setSpan(new UnderlineSpan(),0,18,0);
        spannableString.setSpan(new AlignmentSpan.Standard(Layout.Alignment.ALIGN_CENTER),0,18,0);
        spannableString.setSpan(new RelativeSizeSpan(1.4f),0,18,0);

        spannableString.setSpan(new StyleSpan(Typeface.BOLD),455 + 22,455+21 + 23,0);
        spannableString.setSpan(new UnderlineSpan(),477,499,0);

        spannableString.setSpan(new StyleSpan(Typeface.BOLD),740,750,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),1040,1106,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),1261,1288,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),1492,1537,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),1990,2032,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),2300,2310,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),3035,3049,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),3662,3674,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),4690,4701,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),4993,5009,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),6010,6026,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),6691,6760,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),7650,7685,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),8053,8065,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),12423,12467,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),14045,14097,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD),15670,15688,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD), 16065,16108,0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD), 16108,16108,0);
